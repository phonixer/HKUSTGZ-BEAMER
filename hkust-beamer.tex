...
%\usepackage{mathptmx}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%color%%%%%%%
\definecolor{npu-blue}{RGB}{0, 51, 102}
\definecolor{npu-blue-gray}{RGB}{153,102,0}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\author[author]{
  (subtitle)
  \vskip 20pt Reporter~~: Author ~~~~~~~~~~~
  \vskip 5 pt Supervisor: Prof First name} % ~是占位符

\institute[System Hub]{\small \vskip 60pt Hub-name Hub Thrust of Thrust-name}
...
\centering
\begin{figure}[c]
    \includegraphics[width=1 cm]  {source/pure-logo.pdf} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \tableofcontents[current,currentsubsection,sections={<1-4>}]
    }
